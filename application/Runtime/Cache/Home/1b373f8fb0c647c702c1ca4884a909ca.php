        ...
        <div class="row">
            <main class="col-md-8 main-content">
                <article id=<?php echo ($content["articleid"]); ?> class="post" style="padding-bottom: 10px">
                    <div class="post-head">
                        <h1 class="post-title"><a href="/myblog/index.php/ContentDet/index/articleId/<?php echo ($content["articleid"]); ?>"><?php echo ($content["title"]); ?></a></h1>
                        <div class="post-meta">
                            <span class="author">click：<?php echo ($content["hints"]); ?></span> &bull;
                            <span class="author">作者：<a href="/myblog/index.php/SearchNot/index/keyword/<?php echo ($content["writer"]); ?>"><?php echo ($content["writer"]); ?></a></span> &bull;
