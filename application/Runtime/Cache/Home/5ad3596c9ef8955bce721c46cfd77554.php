...
<head>
    ...
    <link rel="stylesheet" href="/myblog/public/CSS/Album.css">
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="mytab">
            <ul class="nav navbar-nav">
                ...
                <li  class="active"><a href="/myblog/index.php/Album/index.html">相册</a></li>
...
<div class="container">
    <div class="study">
        <h3>博主目前还没有上传任何照片哦</h3>
        <!--<p class="lead" style="font-family: '微软雅黑', '黑体'">只要努力学习，你就赢在了起跑线</p>-->
    </div>
</div>
<!--end-->
</body>
