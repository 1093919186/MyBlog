...
<form class="navbar-form navbar-right" role="search" action="/myblog/admin.php/SearchRep/index" method="post">
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-5">
            <div class="list-group">
                <a href="/myblog/admin.php/AdmReprint/index" class="list-group-item active" style="font-family: '微软雅黑', '黑体'">转载文章</a>
        ...
        <div class="col-md-9 col-sm-7">
            <ul class="breadcrumb">
                ...
                <li class="active" style="font-family: '微软雅黑', '黑体'">转载文章</li>
            </ul>
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                    <?php if(is_array($rep)): foreach($rep as $key=>$v): ?><tr>
                            ...
                            <td><a href="/myblog/admin.php/ChangeArt/index/articleId/<?php echo ($v["articleid"]); ?>" style="font-family: '微软雅黑', '黑体'">修改</a>
                                <a href="/myblog/admin.php/AdmReprint/del/articleId/<?php echo ($v["articleid"]); ?>" style="font-family: '微软雅黑', '黑体';color: red;margin-left: 20px">删除</a></td>
