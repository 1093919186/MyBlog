    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-5">
            <div class="list-group">
                ...
                <a href="/myblog/admin.php/TakeDiary/index" class="list-group-item active" style="font-family: '微软雅黑', '黑体'">记日记</a>
        ...
        <div class="col-md-9 col-sm-7">
            <ul class="breadcrumb">
                ...
                <li class="active" style="font-family: '微软雅黑', '黑体'">记日记</li>
            </ul>
            <form action="/myblog/admin.php/ChangeDia/update" method="post">
                <div class="form-group">
                    <label>Title</label>
                    <input class="form-control" value="<?php echo ($diary["title"]); ?>" style="font-family: '微软雅黑', '黑体'" name="title">
                    <input class="form-control" value="<?php echo ($diary["diaryid"]); ?>" type="hidden" name="diaryId">
                </div>
