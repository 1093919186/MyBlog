...
<!--end-->
<form class="navbar-form navbar-right" role="search" action="/myblog/admin.php/SearchDia/index" method="post">
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-5">
            <div class="list-group">
                ...
                <a href="/myblog/admin.php/AdmDiary/index" class="list-group-item active" style="font-family: '微软雅黑', '黑体'">我的日记</a>
        ...
        <div class="col-md-9 col-sm-7">
            <ul class="breadcrumb">
                ...
                <li class="active" style="font-family: '微软雅黑', '黑体'">我的日记</li>
            </ul>
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <?php if(is_array($diary)): foreach($diary as $key=>$v): ?><tr>
                        ...
                        <td style="font-family: '微软雅黑', '黑体'"><a href="/myblog/admin.php/ChangeDia/index/diaryId/<?php echo ($v["diaryid"]); ?>"><?php echo ($v["title"]); ?></a></td>
                        <td><a href="/myblog/admin.php/ChangeDia/index/diaryId/<?php echo ($v["diaryid"]); ?>" style="font-family: '微软雅黑', '黑体'">修改</a>
                            <a href="/myblog/admin.php/AdmDiary/del/diaryId/<?php echo ($v["diaryid"]); ?>" style="font-family: '微软雅黑', '黑体';color: red;margin-left: 20px">删除</a></td>
