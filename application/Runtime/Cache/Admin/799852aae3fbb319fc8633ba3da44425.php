    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-5">
            <div class="list-group">
                ...
                <a href="/myblog/admin.php/AdmCate/index" class="list-group-item active" style="font-family: '微软雅黑', '黑体'">类目管理</a>
        ...
        <div class="col-md-9 col-sm-7">
            <ul class="breadcrumb">
                ...
                <li class="active" style="font-family: '微软雅黑', '黑体'">类目管理</li>
            </ul>
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <?php if(is_array($cate)): foreach($cate as $key=>$v): ?><tr>
                        <td style="font-family: '微软雅黑', '黑体'"><?php echo ($v["catename"]); ?></td>
                        <td style="font-family: '微软雅黑', '黑体'"><?php echo ($v["articlenums"]); ?></td>
                        <td><a href="/myblog/admin.php/ChangeCate/index/cateId/<?php echo ($v["cateid"]); ?>" style="font-family: '微软雅黑', '黑体'">修改</a>
                            <a href="/myblog/admin.php/AdmCate/del/cateId/<?php echo ($v["cateid"]); ?>" style="font-family: '微软雅黑', '黑体';color: red;margin-left: 20px">删除</a></td>
